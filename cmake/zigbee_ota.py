...
def main(args):
    ...
    with open(args.input_file, "rb") as bin_file:
        ...
        file_version = args.set_version or int.from_bytes(
            firmware[2:6], byteorder="little"
        )
        hs = str.encode("ZigbeeTLc to BLE")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-ot", "--output-title", help="replace original file name with the string"
    )
